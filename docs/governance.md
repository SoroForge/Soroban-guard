...
The governance contract implements M-of-N council voting. A configurable number of
council members must approve an upgrade proposal before it can be forwarded to the
timelock. No single private key can push an upgrade unilaterally.
