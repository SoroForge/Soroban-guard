...
The timelock contract is the enforcement layer of the upgrade pipeline. It records approved upgrade
proposals and prevents execution until a mandatory delay — measured in ledgers — has elapsed.
